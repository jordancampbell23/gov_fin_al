...
liabilities_state_local <- data.frame(label, value)
...
other_type <- 7022788313944 - 2457887263192- 89172550650- 52877771988-96461495003-1671845182218- 1270269047952
...
liabilities_type <- data.frame(label2, value2)
