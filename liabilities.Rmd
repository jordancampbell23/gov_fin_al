...
```{r}
label_state_local <- c("States", "Cities and Towns", "Counties", "Special Districts", "School Districts", "All Other")
...
label_liabilities_type <- c("Bonds", "Loans", "Pensions", "Leases", "Other Post-Employment Benefits", "Notes")

liabilities_type <- data.frame(label_liabilities_type)

liabilities_type$value <- unlist(c(sum(liabilities$bonds_outstanding),
